          ...
          <div className="container">
            {activeButton === "customer" && (
              <>
                ...
                <p>
                  Economical Eats, Timely Treats: Unleash Savings and Slash Food
                  Waste with Foodzee's Exclusive Deals!
                </p>
                <button className="download_btn f_inter">
                  <Link
                    className="text-decoration-none text-white"
                    to={"https://onelink.to/r8ddne"}
                    target="_blank">
                    Download Now!
                  </Link>
                </button>
            ...
            {activeButton === "restaurant" && (
              <>
                <small className="fs_18 f_inter f_clr_00">
                  Welcome to Foodzee
                </small>
                <h1>
                  <span>Your Partner in Maximizing</span> , Revenue and Reducing
                  Waste
                </h1>
                <p>
                  Foodzee's Exclusive Deals can help you save money and reduce
                  food waste by offering affordable meals and timely treats.
                </p>
                <button
                  className="download_btn f_inter me-3"
                ...
                <span className="fs_18 f_inter text-black">
                  ...
                  <Link
                    ...
                    target="_blank"
                    to={
                      "https://appfzeitappdevuw02.azurewebsites.net/Auth/Login/Cover"
                    }>
                    Log in
                  </Link>
                </span>
